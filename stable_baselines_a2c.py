...
if(algo == "A2C" or algo == "PPO2"):
    ...
    if(algo == "A2C"):
        ...
        step_callback = CustomCallbackA(0,actions, env,  num_steps, dir, isLives, env, num_envs, "A2C", env_name)
        ...
        # Stack 4 frames
        env = VecFrameStack(env, n_stack=4)
        step_callback = CustomCallbackA(0,actions, env,  num_steps, dir, isLives, env, num_envs, "PPO2", env_name)
        n_steps = 5

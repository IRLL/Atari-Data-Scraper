...
def find_item_locations_pong():
    ...
    for screen_num in range(num_envs, num_timesteps + num_envs , num_envs):
        ...
        for i in range(num_envs):
            ...
            main_data_dict[key]['ball_coord_x_env_'+ str(i)] = ball_coord[0]
            main_data_dict[key]['ball_coord_y_env_'+ str(i)] = ball_coord[1]
            main_data_dict[key]['green_paddle_coord_x_env_'+ str(i)] = green_paddle_coord[0]
            main_data_dict[key]['green_paddle_coord_y_env_'+ str(i)] = green_paddle_coord[1]
            main_data_dict[key]['brown_paddle_coord_x_env_'+ str(i)] = brown_paddle_coord[0]
            main_data_dict[key]['brown_paddle_coord_y_env_'+ str(i)] = brown_paddle_coord[1]
            main_data_dict[key]['paddle_ball_distance_env_'+ str(i)] = distance
        key += 1
...
csv_input.to_csv(directory + "/compare_to_mod_legit_actual.csv", index=False)
# dataframe is a db table